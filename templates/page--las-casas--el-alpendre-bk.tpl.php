...
/**
 * @file
 * casasreal's theme implementation to display a single Drupal page.
 *
...
<!--main body-->
    <div id="main-wrapper" class="clearfix">
      <div id="main" class="las-casas clearfix">
        <?php if ($breadcrumb): ?>
        ...
        <?php endif; ?>
        <div id="content" class="ghgh column">
          <div class="section">
...
<!--footer-->
    <div id="footer-wrapper">
      <div class="section">
        ...
        <div id="footer-columns" class="clearfix"> <?php print render($page['footer_firstcolumn']); ?> <?php print render($page['footer_secondcolumn']); ?> <?php print render($page['footer_thirdcolumn']); ?> <?php print render($page['footer_fourthcolumn']); ?> </div>
        <!-- /#footer-columns -->
        <?php endif; ?>
        <?php if ($page['footer']): ?>
