                                                        ...
                                                        <tr>
                                                            <td bgcolor="#fff" width="452" valign="top" >
                                                                ...
                                                                <div style="font-size:12px;margin-bottom:8px;">
                                                                  <img src="<?php print url($directory.'/images/email_check_icon.png', array('absolute' => TRUE, 'language' => $variables['lang'])); ?>"/>&nbsp;<?php print t('Arrival date'); ?>: <?php print $room['arrival_date']; ?>
                                                                </div>
                                                                <div style="font-size:12px;margin-bottom:8px;">
                                                                  <img src="<?php print url($directory.'/images/email_check_icon.png', array('absolute' => TRUE, 'language' => $variables['lang'])); ?>"/>&nbsp;<?php print t('Departure date'); ?>: <?php print $room['departure_date']; ?>
                                                                </div>
                                                                <div style="font-size:12px;margin-bottom:8px;">
                                                                  <img src="<?php print url($directory.'/images/email_check_icon.png', array('absolute' => TRUE, 'language' => $variables['lang'])); ?>"/>&nbsp;<?php print t('Occupants'); ?>: <?php print $room['occupants']; ?>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td valign="top" style="text-align:center">
                                                                            <a target="_blank" href="https://maps.google.com/maps?daddr=28.2407197,-16.4334325&amp;ll=28.2407197,-16.4334325&amp;t=z&amp;z=15" style="color:#666;text-decoration:none;"><img style="vertical-align:middle;" src="<?php print url($directory.'/images/email_link_icon.png', array('absolute' => TRUE, 'language' => $variables['lang'])); ?>"/></a>
                                                                                                                                                </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
