...
<body style="background-color: #FFFFFF;color: #666666;font-family: Arial, Helvetica, 'Nimbus Sans L', sans-serif;font-size: 14px;">
<center>
		    ...
		    <table border="0" cellpadding="20" cellspacing="0" width="600" style="background-color: #333333;border-top: 4px solid #E1E1E1;color: #FFFFFF;">
			  <tr>
			    <td valign="top" class="footercontent">
			      <a href="/" style="color: #FFFFFF;">Casas del Camino Real</a></td>
			  </tr>
		    </table>
	      </td>
		</tr>
